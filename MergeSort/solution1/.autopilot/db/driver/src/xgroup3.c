...
void XGroup3_Set_array_r_i(XGroup3 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XGroup3_WriteReg(InstancePtr->Control_BaseAddress, XGROUP3_CONTROL_ADDR_ARRAY_R_I_DATA, Data);
}

u32 XGroup3_Get_array_r_i(XGroup3 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XGroup3_ReadReg(InstancePtr->Control_BaseAddress, XGROUP3_CONTROL_ADDR_ARRAY_R_I_DATA);
    return Data;
}

u32 XGroup3_Get_array_r_o(XGroup3 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XGroup3_ReadReg(InstancePtr->Control_BaseAddress, XGROUP3_CONTROL_ADDR_ARRAY_R_O_DATA);
    return Data;
}

u32 XGroup3_Get_array_r_o_vld(XGroup3 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XGroup3_ReadReg(InstancePtr->Control_BaseAddress, XGROUP3_CONTROL_ADDR_ARRAY_R_O_CTRL);
    return Data & 0x1;
}
