set moduleName mergeSort_Pipeline_VITIS_LOOP_42_7
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {mergeSort_Pipeline_VITIS_LOOP_42_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ n int 32 regular  }
	{ temp int 32 regular {array 30 { 1 3 } 1 1 }  }
	{ arr_1_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "n", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "temp", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "arr_1_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ temp_address0 sc_out sc_lv 5 signal 1 } 
	{ temp_ce0 sc_out sc_logic 1 signal 1 } 
	{ temp_q0 sc_in sc_lv 32 signal 1 } 
	{ arr_1_out sc_out sc_lv 32 signal 2 } 
	{ arr_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "arr_1_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	temp { ap_memory {  { temp_address0 mem_address 1 5 }  { temp_ce0 mem_ce 1 1 }  { temp_q0 in_data 0 32 } } }
	arr_1_out { ap_vld {  { arr_1_out out_data 1 32 }  { arr_1_out_ap_vld out_vld 1 1 } } }
}
