...
void group3(signed int *, signed int , signed int *);


/* Global Variable Definitions and Initialization */
static signed int aesl_internal_main_OC_array[5] = { 12u, 11u, 13u, 5u, 6u };
static  char aesl_internal_str[13] = "Merge Sort: ";
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @group3(i32* %%4, i32 5, i32* %%.sub) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
  group3((signed int *)llvm_cbe_tmp__4, 5u, (signed int *)llvm_cbe__2e_sub);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",5u);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([13 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
