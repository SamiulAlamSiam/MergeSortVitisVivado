...
`define AUTOTB_DUT      group3
`define AUTOTB_DUT_INST AESL_inst_group3
`define AUTOTB_TOP      apatb_group3_top
`define AUTOTB_LAT_RESULT_FILE "group3.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "group3.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_group3_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_array_r 1
`define AESL_DEPTH_array_size 1
`define AESL_DEPTH_output_r 1
`define AUTOTB_TVIN_array_size  "../tv/cdatafile/c.group3.autotvin_array_size.dat"
`define AUTOTB_TVIN_array_size_out_wrapc  "../tv/rtldatafile/rtl.group3.autotvin_array_size.dat"
`define AUTOTB_TVOUT_array_r  "../tv/cdatafile/c.group3.autotvout_array_r.dat"
`define AUTOTB_TVOUT_output_r  "../tv/cdatafile/c.group3.autotvout_output_r.dat"
`define AUTOTB_TVOUT_array_r_out_wrapc  "../tv/rtldatafile/rtl.group3.autotvout_array_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "../tv/rtldatafile/rtl.group3.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_array_r = 1;
parameter LENGTH_array_size = 1;
...
reg end_array_size;
reg [31:0] size_array_size;
reg [31:0] size_array_size_backup;
reg end_array_r;
reg [31:0] size_array_r;
reg [31:0] size_array_r_backup;
reg end_output_r;
...
reg dump_tvout_finish_array_r;

initial begin : dump_tvout_runtime_sign_array_r
    integer fp;
    dump_tvout_finish_array_r = 0;
    fp = $fopen(`AUTOTB_TVOUT_array_r_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_array_r_out_wrapc);
    ...
    fp = $fopen(`AUTOTB_TVOUT_array_r_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_array_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
