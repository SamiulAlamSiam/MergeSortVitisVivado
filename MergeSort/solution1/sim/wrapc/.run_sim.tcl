...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Software/Embeded/xilinx/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Software/Embeded/xilinx/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Software/Embeded/xilinx/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Software/Embeded/xilinx/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "group3.autotvin.dat"
	set constFileTvOut       "group3.autotvout.dat"
	set constFileHdlTvIn     "group3.autohdltvin.dat"
	set constFileHdlTvOut    "group3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
