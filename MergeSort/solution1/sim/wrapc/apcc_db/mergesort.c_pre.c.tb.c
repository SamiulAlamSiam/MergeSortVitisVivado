...
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%15, i32 %%14, i32 %%2, !dbg !5 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe__2e__count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%59 = add nsw i32 %%58, %%storemerge33, !dbg !5 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_173_count);
...
llvm_cbe_tmp__60:
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = add nsw i32 %%storemerge2521, 1, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_83_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = sext i32 %%20 to i64, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_96_count);
  llvm_cbe_tmp__20 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = getelementptr inbounds [30 x i32]* %%temp, i64 0, i64 %%30, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_97_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%23, i32* %%31, align 4, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_98_count);
...
llvm_cbe_tmp__59:
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = add nsw i32 %%19, 1, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_100_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = sext i32 %%20 to i64, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__23 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = getelementptr inbounds [30 x i32]* %%temp, i64 0, i64 %%34, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_108_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%26, i32* %%35, align 4, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_109_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = add nsw i32 %%storemerge2314, 1, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_118_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = sext i32 %%storemerge2314 to i64, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_131_count);
  llvm_cbe_tmp__27 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge2314);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = getelementptr inbounds i32* %%arr, i64 %%41, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_132_count);
  llvm_cbe_tmp__28 = (signed int *)(&llvm_cbe_arr[(((signed long long )llvm_cbe_tmp__27))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__27));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = load i32* %%42, align 4, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_133_count);
  llvm_cbe_tmp__29 = (unsigned int )*llvm_cbe_tmp__28;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = add nsw i32 %%39, 1, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_134_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = sext i32 %%39 to i64, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_142_count);
  llvm_cbe_tmp__31 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = getelementptr inbounds [30 x i32]* %%temp, i64 0, i64 %%45, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_143_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%43, i32* %%46, align 4, !dbg !4 for 0x%I64xth hint within @mergeSort  --> \n", ++aesl_llvm_cbe_144_count);
