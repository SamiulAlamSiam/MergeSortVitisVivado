...
AUTOPILOT_ROOT := D:/Software/Embeded/xilinx/Vitis_HLS/2022.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := D:/Software/Embeded/xilinx/Vitis_HLS/2022.2/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/mergesort_tb.c_pre.c.tb.o : mergesort_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) mergesort_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/mergesort.c_pre.c.tb.o : mergesort.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) mergesort.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
